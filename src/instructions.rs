...
lazy_static! {
    pub static ref CPU_OPCODES: Vec<OpCode> = vec![
        ...
        //BPL
        OpCode::new(0x10, "BNE", 2, 2/* +1 if branch succeeds, +2 if to a new page*/, AddressingMode::NoneAddressing),
        //BRK
        ...
        //INX
        OpCode::new(0xE8, "INC", 1, 2, AddressingMode::NoneAddressing),
        //INY
        ...
        OpCode::new(0x3E, "ROL", 3, 7 /* +1 if page crossed */, AddressingMode::AbsoluteX),
        //ROR
        OpCode::new(0x6A, "ROR", 1, 2, AddressingMode::NoneAddressing),
        OpCode::new(0x66, "ROR", 2, 5, AddressingMode::ZeroPage),
        OpCode::new(0x76, "ROR", 2, 6, AddressingMode::ZeroPageX),
        OpCode::new(0x6E, "ROR", 3, 6, AddressingMode::Absolute),
        OpCode::new(0x7E, "ROR", 3, 7 /* +1 if page crossed */, AddressingMode::AbsoluteX),
        //RTI
        ...
        OpCode::new(0x9D, "STA", 3, 5 /* +1 if page crossed */, AddressingMode::AbsoluteX),
        OpCode::new(0x99, "STA", 3, 5 /* +1 if page crossed */, AddressingMode::AbsoluteY),
        OpCode::new(0x81, "STA", 2, 6, AddressingMode::IndirectX),
        OpCode::new(0x91, "STA", 2, 6 /* +1 if page crossed */, AddressingMode::IndirectY),
        //STX
    ...
    pub static ref OPCODES_MAP: HashMap<u8, &'static OpCode> = {
        ...
        for cpuop in CPU_OPCODES.iter() {
            map.insert(cpuop.opcode, cpuop);
        }
        map
    };
}
